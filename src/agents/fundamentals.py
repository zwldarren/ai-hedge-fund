...
def fundamentals_analyst_agent(state: AgentState):
    ...
    for ticker in tickers:
        progress.update_status(
            "fundamentals_analyst_agent", ticker, "Fetching financial metrics"
        )
        ...
        progress.update_status(
            "fundamentals_analyst_agent", ticker, "Analyzing profitability"
        )
        ...
        progress.update_status(
            "fundamentals_analyst_agent", ticker, "Analyzing financial health"
        )
        # 3. Financial Health
        ...
        progress.update_status(
            "fundamentals_analyst_agent", ticker, "Analyzing valuation ratios"
        )
        # 4. Price to X ratios
        ...
        progress.update_status(
            "fundamentals_analyst_agent", ticker, "Calculating final signal"
        )
